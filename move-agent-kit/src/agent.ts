...
import {
	...
	unstakeTokens,
	withdrawToken,
	scrapeStakingOpportunities,
	analyzeStakingOpportunities,
} from "./tools"
import {
	borrowAriesToken,
	createAriesProfile,
...
export class AgentRuntime {
	...
	/**
	 * Scrape available staking opportunities from various sources
	 * @returns Array of staking opportunities
	 */
	async scrapeStakingOpportunities() {
		return scrapeStakingOpportunities(this)
	}

	/**
	 * Analyze and find the best staking opportunities
	 * @returns Analysis results with best opportunities by different criteria
	 */
	async analyzeStakingOpportunities() {
		return analyzeStakingOpportunities(this)
	}
}
