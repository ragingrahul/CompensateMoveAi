...
const PAYROLL_FEATURES = [
  {
    ...
    category: "payments",
    color: "#8B5CF6", // Purple
    description: "Support for BTC, ETH, USDC, and 20+ cryptocurrencies",
  },
  {
  ...
  },
  {
    ...
    category: "technology",
    color: "#10B981", // Green
    description: "Automated execution with ironclad security",
  },
  {
    name: "Tax Compliance",
  ...
  },
  {
    ...
    icon: "/icons/features/calendar.svg",
    category: "automation",
    color: "#0EA5E9", // Sky
    description: "Set it and forget it recurring payments",
  },
  {
    name: "Wallet Generation",
    icon: "/icons/features/wallet.svg",
    category: "security",
    color: "#8B5CF6", // Purple
    description: "Create secure wallets for new employees instantly",
  },
  {
    name: "Audit Trails",
...
const CRYPTOCURRENCIES = [
  { symbol: "BTC", name: "Bitcoin", icon: "/icons/bitcoin-btc-logo.svg" },
  { symbol: "ETH", name: "Ethereum", icon: "/icons/ethereum-eth-logo.svg" },
  { symbol: "SOL", name: "Solana", icon: "/icons/solana-sol-logo.svg" },
  { symbol: "USDC", name: "USD Coin", icon: "/icons/usd-coin-usdc-logo.svg" },
  { symbol: "USDT", name: "Tether", icon: "/icons/tether-usdt-logo.svg" },
  { symbol: "APT", name: "Aptos", icon: "/icons/aptos-apt-logo.svg" },
];
      ...
      >
        ...
        <div className="p-4 h-full flex flex-col">
          ...
          <div className="bg-gray-50 rounded-lg p-3 mb-4 flex items-center">
            ...
            <div>
              <div className="text-sm text-gray-500">Selected Currency</div>
      ...
      <div className="container relative mx-auto px-4 z-10">
        <div className="flex flex-wrap md:flex-nowrap items-center gap-16">
          ...
          <div className="w-full md:w-1/2 space-y-8">
            ...
            >
              Everything You Need for Crypto Payroll
            </motion.h2>
            ...
            >
              Compensate is a complete, standalone payroll solution built for
              the blockchain era. Manage every aspect of your global payroll
              operations from a single powerful platform.
            </motion.p>
        ...
        <div className="mt-24 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600">
              Pay your team in their preferred digital currency
            </p>
          </motion.div>
