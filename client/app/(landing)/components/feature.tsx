...
const Icons = {
  bitcoin: "/icons/bitcoin-btc-logo.svg",
  aptos: "/icons/aptos-apt-logo.svg",
            ...
            <div className="relative flex h-full w-full flex-col items-center justify-center rounded-lg border bg-purple-img-light">
              ...
              <OrbitingCircles iconSize={40}>
                <Image
                  ...
                  alt="Bitcoin"
                />
                <Image src={Icons.aptos} width={40} height={40} alt="Aptos" />
                <Image
                  src={Icons.ethereum}
                  width={40}
                  height={40}
                  alt="Ethereum"
                />
                <Image src={Icons.solana} width={40} height={40} alt="Solana" />
              ...
              <OrbitingCircles iconSize={30} radius={100} reverse speed={2}>
                <Image
                  ...
                  alt="Bitcoin"
                />
                <Image src={Icons.aptos} width={30} height={30} alt="Aptos" />
                <Image
                  src={Icons.ethereum}
                  width={30}
                  height={30}
                  alt="Ethereum"
                />
                <Image src={Icons.solana} width={30} height={30} alt="Solana" />
              </OrbitingCircles>
            </div>
          </div>
